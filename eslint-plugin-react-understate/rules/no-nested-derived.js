...
module.exports = {
  meta: {
    type: 'problem',
    docs: {
      description: 'Prevent nested derived() calls which can cause performance issues and unexpected behavior',
    ...
    schema: [],
    messages: {
      noNestedDerived: 'Nested derived() calls are not allowed. Move the inner derived outside or combine them into a single derived.',
    },
  },
