...
module.exports = {
  meta: {
    type: 'problem',
    docs: {
      description: 'Require useSubscribe when state.value is used in React components',
    ...
    schema: [],
    messages: {
      missingUseSubscribe: 'Missing useSubscribe call for state "{{stateName}}". Add useSubscribe({{stateName}}) to subscribe to state changes.',
    },
  },
