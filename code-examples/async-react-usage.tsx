...
import {
  ...
  error,
  isEmpty,
} from './async-basic-store';
import {
  fetchUsersWithCancellation,
  cancelCurrentRequest,
} from './async-cancellation';
import { createResourceManager } from './async-resource-manager';
...
export const userResource = createResourceManager(
  async signal => {
...
export function UserListWithResource() {
