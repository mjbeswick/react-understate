...
// Test to demonstrate the correct optimization behavior
const a = state(1, 'a');
const b = state(2, 'b');
...
// Test case: change dependencies so result stays the same
...
// Change b so that sum goes back to original value - this should also trigger subscriber
...
console.log('\n--- Testing same result ---');
console.log('Current sum:', sum.value);
console.log('Subscriber calls before same-result test:', subscriberCallCount);
...
b.value = 0; // Now a=3, b=0, sum=3 (same as before a change)
console.log('After changing b to 0, sum:', sum.value); // 3
console.log('Subscriber calls so far:', subscriberCallCount); // Should be 4

// Test case: change dependencies but result stays exactly the same
console.log('\n--- Testing exact same result ---');
console.log('Current sum:', sum.value);
console.log('Subscriber calls before exact-same test:', subscriberCallCount);

// Change both dependencies but result stays exactly the same
...
b.value = -1; // Now a=4, b=-1, sum=3 (same as before a change)
console.log('After changing b to -1, sum:', sum.value); // 3
console.log('Subscriber calls so far:', subscriberCallCount); // Should be 6

// Test case: change dependencies but result stays exactly the same (this should NOT trigger)
console.log('\n--- Testing no change ---');
console.log('Current sum:', sum.value);
console.log('Subscriber calls before no-change test:', subscriberCallCount);
...
b.value = -2; // Now a=5, b=-2, sum=3 (same as before a change)
console.log('After changing b to -2, sum:', sum.value); // 3
console.log('Subscriber calls so far:', subscriberCallCount); // Should be 8

// Test case: change dependencies but result stays exactly the same (this should NOT trigger)
console.log('\n--- Testing no change (should not trigger) ---');
console.log('Current sum:', sum.value);
console.log('Subscriber calls before no-change test:', subscriberCallCount);
...
console.log('Subscriber calls so far:', subscriberCallCount); // Should be 9

b.value = -3; // Now a=6, b=-3, sum=3 (same as before a change)
console.log('After changing b to -3, sum:', sum.value); // 3
console.log('Subscriber calls so far:', subscriberCallCount); // Should be 10
...
console.log('Subscriber calls so far:', subscriberCallCount); // Should be 11

b.value = -4; // Now a=7, b=-4, sum=3 (same as before a change)
console.log('After changing b to -4, sum:', sum.value); // 3
console.log('Subscriber calls so far:', subscriberCallCount); // Should be 12
