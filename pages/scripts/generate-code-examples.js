...
function generate() {
  ...
  const tsLines = [];
  tsLines.push('// This file is auto-generated by scripts/generate-code-examples.js');
  ...
  for (const base of entries) {
    ...
    tsLines.push(`export const ${exportName}: string = (examples as any)['${exportName}'];`);
  }
  tsLines.push('');
  ...
  console.log('Generated', outTs, 'and', outJson, 'with', entries.length, 'exports');
}
